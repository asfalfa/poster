...
export default function CreateMain() {
    ...
    const handleSubmit = async (event) => {
        ...
        await axios.post('http://localhost:3030/projects/create', formData).then(res => {
                ...
                <div className="pt-8 pb-6">
                    <form method="post" onSubmit={handleSubmit} className="flex-col grid gap-y-8 px-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex justify-evenly items-center w-1/2 m-auto">
                        ...
                        <button 
                        type="submit" 
                        className="uppercase font-bold py-4 bg-neutral-800 hover:bg-neutral-700 transition duration-200 rounded-md w-1/3 m-auto">
                            Create Project
                        </button>
                    </form>
                </div>
